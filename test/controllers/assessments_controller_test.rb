...
class AssessmentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create assessment" do
    assert_difference('Assessment.count') do
      post assessments_url, params: { assessment: { birthdate: @assessment.birthdate, city: @assessment.city, country: @assessment.country, gender: @assessment.gender, last_name: @assessment.last_name, name: @assessment.name, priority: @assessment.priority } }
    end
  ...
  test "should update assessment" do
    patch assessment_url(@assessment), params: { assessment: { birthdate: @assessment.birthdate, city: @assessment.city, country: @assessment.country, gender: @assessment.gender, last_name: @assessment.last_name, name: @assessment.name, priority: @assessment.priority } }
